...
<option></option>
 ...
 <input name="enviaou"  type="submit" value="Gerar Relatório">
...
if(isset($_POST['enviaou'])){
  ...
  $curso ="AND Cod_cur LIKE '".$_POST['curso']."%'";
  $sis =$_POST['sistema']."%";
 ...
 header("Location:gerar_relatotio.php");
